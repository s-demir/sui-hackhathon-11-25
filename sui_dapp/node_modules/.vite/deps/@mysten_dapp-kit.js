import {
  ...
  composeRefs,
  require_shim
} from "./chunk-JWUP7GLT.js";
import "./chunk-TGLSLBTF.js";
import {
  SuiJsonRpcClient,
  getFullnodeUrl,
  isSuiJsonRpcClient
} from "./chunk-JDUTLIT3.js";
import "./chunk-LVLI52XX.js";
import {
  ...
  uuid,
  variant
} from "./chunk-FY23GS5F.js";
import {
  require_poseidon_lite
} from "./chunk-7DOP6V4E.js";
import {
  Chi,
  Hash,
  HashMD,
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React2 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef2 = React2.useRef, useEffect4 = React2.useEffect, useMemo3 = React2.useMemo, useDebugValue2 = React2.useDebugValue;
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  function aValidRS(title3, num) {
    if (!Fn2.isValidNot0(num))
      throw new Error(`invalid signature ${title3}: out of range 1..CURVE.n`);
  }
  class Signature {
    ...
    static fromBytes(bytes, format = "compact") {
      if (format === "compact") {
        ...
        return new Signature(Fn2.fromBytes(r2), Fn2.fromBytes(s));
      }
      if (format === "der") {
        abytes(bytes);
        const { r: r2, s } = DER.toSig(bytes);
...
var PublicKey = class {
  ...
  verifyWithIntent(bytes, signature, intent) {
    ...
    const digest2 = blake2b(intentMessage, { dkLen: 32 });
    return this.verify(digest2, signature);
  }
  /**
...
var AddressTransactionRelationship = ((AddressTransactionRelationship2) => {
...
var ConsensusObjectCancellationReason = ((ConsensusObjectCancellationReason2) => {
...
var Signer = class {
  ...
  async signWithIntent(bytes, intent) {
    ...
    const signature = toSerializedSignature({
      signature: await this.sign(digest2),
...
function CloseIcon(props) {
  return (0, import_jsx_runtime3.jsx)("svg", { width: 10, height: 10, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime3.jsx)(
    "path",
    {
...
var StyleMarker = (0, import_react5.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime4.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
  ...
  ({
    ...
    return (0, import_jsx_runtime5.jsx)(
      Slot,
      {
        ...
        children: asChild ? children : (0, import_jsx_runtime5.jsx)(Tag, { children })
      }
    );
  }
);
...
var IconButton = (0, import_react7.forwardRef)(
  ({ className, asChild = false, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(Comp, { ...props, className: clsx_default(container, className), ref: forwardedRef });
  }
);
  ...
  ({
    ...
    return (0, import_jsx_runtime8.jsx)(
      Slot,
      {
        ...
        children: asChild ? children : (0, import_jsx_runtime8.jsx)(Tag, { children })
      }
    );
  }
);
...
function ConnectionStatus({
  ...
  return (0, import_jsx_runtime9.jsxs)("div", { className: container2, children: [
    selectedWallet.icon && (0, import_jsx_runtime9.jsx)(
      "img",
      {
    ...
    (0, import_jsx_runtime9.jsx)("div", { className: title2, children: (0, import_jsx_runtime9.jsxs)(Heading, { as: "h2", size: "xl", children: [
      "Opening ",
      selectedWallet.name
    ] }) }),
    (0, import_jsx_runtime9.jsx)("div", { className: connectionStatus, children: hadConnectionError ? (0, import_jsx_runtime9.jsx)(Text, { color: "danger", children: "Connection failed" }) : (0, import_jsx_runtime9.jsx)(Text, { color: "muted", children: "Confirm connection in the wallet..." }) }),
    hadConnectionError ? (0, import_jsx_runtime9.jsx)("div", { className: retryButtonContainer, children: (0, import_jsx_runtime9.jsx)(Button, { type: "button", variant: "outline", onClick: () => onRetryConnection(selectedWallet), children: "Retry Connection" }) }) : null
  ] });
}
var container3 = "InfoSection_container__1wtioi70";
function InfoSection({ title: title3, children }) {
  return (0, import_jsx_runtime10.jsxs)("section", { className: container3, children: [
    (0, import_jsx_runtime10.jsx)(Heading, { as: "h3", size: "sm", weight: "normal", children: title3 }),
    (0, import_jsx_runtime10.jsx)(Text, { weight: "medium", color: "muted", children })
  ] });
}
...
function GettingStarted() {
  return (0, import_jsx_runtime11.jsxs)("div", { className: container4, children: [
    (0, import_jsx_runtime11.jsx)(Heading, { as: "h2", children: "Get Started with Sui" }),
    (0, import_jsx_runtime11.jsxs)("div", { className: content2, children: [
      (0, import_jsx_runtime11.jsx)(InfoSection, { title: "Install the Sui Wallet Extension", children: "We recommend pinning Sui Wallet to your taskbar for quicker access." }),
      (0, import_jsx_runtime11.jsx)(InfoSection, { title: "Create or Import a Wallet", children: "Be sure to back up your wallet using a secure method. Never share your secret phrase with anyone." }),
      (0, import_jsx_runtime11.jsx)(InfoSection, { title: "Refresh Your Browser", children: "Once you set up your wallet, refresh this window browser to load up the extension." }),
      (0, import_jsx_runtime11.jsx)("div", { className: installButtonContainer, children: (0, import_jsx_runtime11.jsx)(Button, { variant: "outline", asChild: true, children: (0, import_jsx_runtime11.jsx)(
        "a",
        {
...
function WhatIsAWallet() {
  return (0, import_jsx_runtime12.jsxs)("div", { className: container5, children: [
    (0, import_jsx_runtime12.jsx)(Heading, { as: "h2", children: "What is a Wallet" }),
    (0, import_jsx_runtime12.jsxs)("div", { className: content3, children: [
      (0, import_jsx_runtime12.jsx)(InfoSection, { title: "Easy Login", children: "No need to create new accounts and passwords for every website. Just connect your wallet and get going." }),
      (0, import_jsx_runtime12.jsx)(InfoSection, { title: "Store your Digital Assets", children: "Send, receive, store, and display your digital assets like NFTs & coins." })
    ] })
  ] });
}
function SuiIcon(props) {
  return (0, import_jsx_runtime13.jsxs)("svg", { width: 28, height: 28, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: [
    (0, import_jsx_runtime13.jsx)("rect", { width: 28, height: 28, rx: 6, fill: "#6FBCF0" }),
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime14.jsx)("li", { className: container7, children: (0, import_jsx_runtime14.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime14.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
        (0, import_jsx_runtime14.jsx)(Heading, { size: "md", truncate: true, asChild: true, children: (0, import_jsx_runtime14.jsx)("div", { children: name }) })
      ]
    }
  ) });
}
function WalletList({
  ...
  return (0, import_jsx_runtime15.jsx)("ul", { className: container6, children: wallets2.length > 0 ? wallets2.map((wallet) => (0, import_jsx_runtime15.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
    ...
    {
      name: "Sui Wallet",
      icon: (0, import_jsx_runtime15.jsx)(SuiIcon, {}),
...
function ConnectModal({
  ...
  switch (currentView) {
    case "what-is-a-wallet":
      modalContent = (0, import_jsx_runtime16.jsx)(WhatIsAWallet, {});
      break;
    case "getting-started":
      modalContent = (0, import_jsx_runtime16.jsx)(GettingStarted, {});
      break;
    case "connection-status":
      modalContent = (0, import_jsx_runtime16.jsx)(
        ConnectionStatus,
        {
          selectedWallet,
  ...
  return (0, import_jsx_runtime16.jsxs)(Root, { open: open ?? isModalOpen, onOpenChange: handleOpenChange, children: [
    (0, import_jsx_runtime16.jsx)(Trigger, { asChild: true, children: trigger }),
    (0, import_jsx_runtime16.jsx)(Portal, { children: (0, import_jsx_runtime16.jsx)(StyleMarker, { children: (0, import_jsx_runtime16.jsx)(Overlay, { className: overlay, children: (0, import_jsx_runtime16.jsxs)(Content, { className: content, "aria-describedby": void 0, children: [
      (0, import_jsx_runtime16.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime16.jsxs)("div", { className: walletListContent, children: [
              (0, import_jsx_runtime16.jsx)(Title, { className: title, asChild: true, children: (0, import_jsx_runtime16.jsx)(Heading, { as: "h2", children: "Connect a Wallet" }) }),
      ...
      (0, import_jsx_runtime16.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime16.jsx)("div", { className: backButtonContainer, children: (0, import_jsx_runtime16.jsx)(IconButton, { type: "button", "aria-label": "Back", onClick: () => resetSelection(), children: (0, import_jsx_runtime16.jsx)(BackIcon, {}) }) }),
            modalContent
          ]
        }
      ),
      (0, import_jsx_runtime16.jsx)(Close, { className: closeButtonContainer, asChild: true, children: (0, import_jsx_runtime16.jsx)(IconButton, { type: "button", "aria-label": "Close", children: (0, import_jsx_runtime16.jsx)(CloseIcon, {}) }) })
    ] }) }) }) })
  ] });
}
...
function SuiClientProvider(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(SuiClientContext.Provider, { value: ctx, children });
}
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime20.jsxs)(Root2, { modal: false, children: [
    (0, import_jsx_runtime20.jsx)(StyleMarker, { children: (0, import_jsx_runtime20.jsx)(Trigger2, { asChild: true, children: (0, import_jsx_runtime20.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
      (0, import_jsx_runtime20.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? domain ?? formatAddress(currentAccount.address) }),
      (0, import_jsx_runtime20.jsx)(ChevronIcon, {})
    ] }) }) }),
    (0, import_jsx_runtime20.jsx)(Portal2, { children: (0, import_jsx_runtime20.jsx)(StyleMarker, { className: menuContainer, children: (0, import_jsx_runtime20.jsxs)(Content2, { className: menuContent, children: [
      accounts.map((account) => (0, import_jsx_runtime20.jsx)(
      ...
      (0, import_jsx_runtime20.jsx)(Separator2, { className: separator }),
...
function AccountDropdownMenuItem({
  ...
  return (0, import_jsx_runtime20.jsxs)(
    Item2,
    {
      ...
      children: [
        (0, import_jsx_runtime20.jsx)(Text, { mono: true, children: account.label ?? domain ?? formatAddress(account.address) }),
        active ? (0, import_jsx_runtime20.jsx)(CheckIcon, {}) : null
      ]
    }
  );
}
function ConnectButton({
  ...
  return currentAccount ? (0, import_jsx_runtime21.jsx)(AccountDropdownMenu, { currentAccount }) : (0, import_jsx_runtime21.jsx)(
    ConnectModal,
    {
      walletFilter,
      trigger: (0, import_jsx_runtime21.jsx)(StyleMarker, { children: (0, import_jsx_runtime21.jsx)(Button, { ...buttonProps, children: connectText }) })
    }
  );
}
...
function WalletProvider({
  ...
  return (0, import_jsx_runtime23.jsx)(WalletContext.Provider, { value: storeRef.current, children: (0, import_jsx_runtime23.jsxs)(
    WalletConnectionManager,
    {
      ...
      slushWallet,
      children: [
        theme ? (0, import_jsx_runtime23.jsx)(InjectedThemeStyles, { theme }) : null,
        children
      ]
    }
  ) });
