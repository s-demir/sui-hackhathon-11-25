...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/b58.js
var toBase58 = (buffer) => esm_default2.encode(buffer);
var fromBase58 = (str) => esm_default2.decode(str);

// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/b64.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/hex.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/uleb.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/reader.js
var BcsReader = class {
  /**
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/utils.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/writer.js
var BcsWriter = class {
  constructor({
    initialSize = 1024,
    maxSize = Infinity,
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/bcs-type.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
var _BcsType = class _BcsType2 {
  ...
  transform({
    ...
    return new _BcsType2({
      ...
      write: (value2, writer) => __privateGet(this, _write).call(this, input(value2), writer),
      serializedSize: (value2) => this.serializedSize(input(value2)),
      serialize: (value2, options) => __privateGet(this, _serialize).call(this, input(value2), options),
      validate: (value2) => {
        validate?.(value2);
...
// node_modules/@mysten/zklogin/node_modules/@mysten/bcs/dist/esm/bcs.js
var bcs = {
  /**
  ...
  bytes(size, options) {
    return fixedSizeBcsType({
      ...
      write: (value2, writer) => {
        const array = new Uint8Array(value2);
        for (let i2 = 0; i2 < size; i2++) {
          writer.write8(array[i2] ?? 0);
        }
      },
      ...options,
      validate: (value2) => {
  ...
  tuple(types2, options) {
    return new BcsType({
      name: `(${types2.map((t3) => t3.name).join(", ")})`,
      ...
      validate: (value2) => {
        ...
        if (value2.length !== types2.length) {
          throw new TypeError(`Expected array of length ${types2.length}, found ${value2.length}`);
        }
      }
    });
  },
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/cryptography/signature-scheme.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/bcs.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/signature.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/poseidon.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/utils.js
...
function chunkArray(array, chunk_size) {
  ...
  for (let i2 = 0; i2 < chunks.length; i2++) {
    chunks[i2] = revArray.slice(i2 * chunk_size, (i2 + 1) * chunk_size).reverse();
  }
...
function genAddressSeed(salt, name2, value2, aud, max_name_length = MAX_KEY_CLAIM_NAME_LENGTH, max_value_length = MAX_KEY_CLAIM_VALUE_LENGTH, max_aud_length = MAX_AUD_VALUE_LENGTH) {
  return poseidonHash([
    hashASCIIStrToField(name2, max_name_length),
    hashASCIIStrToField(value2, max_value_length),
    hashASCIIStrToField(aud, max_aud_length),
    poseidonHash([BigInt(salt)])
  ]);
}

// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/runtime/webcrypto.js
var webcrypto_default = crypto;
var isCryptoKey = (key) => key instanceof CryptoKey;

// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/buffer_utils.js
var encoder = new TextEncoder();
var decoder = new TextDecoder();
var MAX_INT32 = 2 ** 32;

// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/runtime/base64url.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/util/errors.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/runtime/random.js
var random_default = webcrypto_default.getRandomValues.bind(webcrypto_default);

// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/invalid_key_input.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/runtime/is_key_like.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/is_object.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/is_jwk.js
function isJWK(key) {
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/check_key_type.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/private_symbols.js
var unprotected = Symbol();

// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/lib/secs.js
var minute = 60;
var hour = minute * 60;
var day = hour * 24;
var week = day * 7;
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/jwks/remote.js
var USER_AGENT;
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/util/base64url.js
...
// node_modules/@mysten/zklogin/node_modules/jose/dist/browser/util/decode_jwt.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/utils/sui-types.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/utils/constants.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/bcs/type-tag-serializer.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/bcs/bcs.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/bcs/effects.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/bcs/index.js
var suiBcs = {
  ...bcs,
  U8: bcs.u8(),
  U16: bcs.u16(),
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/address.js
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/graphql/client.js
var _url;
var _queries;
var _headers;
var _fetch;
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/graphql/schemas/2024.4/index.js
var graphql = initGraphQLTada();

// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/publickey.js
var _data;
var _client;
var _legacyAddress;
...
// node_modules/@mysten/zklogin/node_modules/@mysten/sui/dist/esm/zklogin/nonce.js
var NONCE_LENGTH = 27;
